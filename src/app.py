...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique training and endurance swimming sessions",
    ...
    "Painting Workshop": {
        "description": "Explore painting techniques and art history",
    ...
    "Debate Team": {
        "description": "Research, argument crafting, and formal debate practice",
